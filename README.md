...
Simply fork this repository and customise. Search and Replace (case-sensitive) `Dewsign` and `NovaNavigation` as well as `dewsign` and `nova-navigation` to get started.
